...
static const char col_bord[]     = "#282828";
static const char col_fg[]       = "#abb2bf";
static const char col_bg_sel[]   = "#282828";
static const char col_bord_sel[] = "#282828";
static const char col_fg_sel[]   = "#eeeeee";
static const char *colors[][3]   = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_fg,     col_bg,          col_bord },
	[SchemeSel]  = { col_fg_sel, col_bg_sel,  col_bord_sel },
};

/* custom keybindings */
static const char *print_cmd[] = { "deepin-screenshot", NULL, NULL};
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_Print,  spawn,          {.v = print_cmd} },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
